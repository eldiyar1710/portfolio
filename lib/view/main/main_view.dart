            ...
            child: Column(
              children: [
                kIsWeb && !Responsive.isLargeMobile(context) ? const SizedBox(height:defaultPadding*2,) : const SizedBox(height:defaultPadding/2,),
                 SizedBox(
                    height: 80,
                    child: TopNavigationBar(openDrawer: () => scaffoldKey.currentState?.openDrawer()),
                ),
                if(Responsive.isLargeMobile(context))  Row(children: [Spacer(),NavigationButtonList(openDrawer: () => scaffoldKey.currentState?.openDrawer()),Spacer()],),
                Expanded(
                    flex: 9,
                    child: PageView(
